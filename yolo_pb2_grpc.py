...
class ImageProcedureStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ImageMeanWH = channel.unary_unary(
                ...
                request_serializer=yolo__pb2.B64Image.SerializeToString,
                response_deserializer=yolo__pb2.Prediction.FromString,
...
def add_ImageProcedureServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ImageMeanWH': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=yolo__pb2.B64Image.FromString,
                    response_serializer=yolo__pb2.Prediction.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'ImageProcedure', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ImageProcedure', rpc_method_handlers)
...
class ImageProcedure(object):
    ...
    def ImageMeanWH(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ImageProcedure/ImageMeanWH',
            yolo__pb2.B64Image.SerializeToString,
            yolo__pb2.Prediction.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
